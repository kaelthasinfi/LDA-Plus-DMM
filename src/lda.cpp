 ...
 * Copyright (C) 2007 by
 * 
 * 	Xuan-Hieu Phan *	hieuxuan@ecei.tohoku.ac.jp or pxhieu@gmail.com
...
int main(int argc, char ** argv) {
    ...
    if (lda.model_status == MODEL_STATUS_EST || lda.model_status == MODEL_STATUS_ESTC) {
		...
		//lda.estimate();
		//printf("est!\n");
		//lda.trans_into_new_doc();
		//lda.DMM_init(lda.newdoc_forDMM);
		//lda.DMM_estimate();
		GSDMM.Baseline_GSDMM();
    }
